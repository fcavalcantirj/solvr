...
export default function NewProblemPage() {
  ...
  return (
    <main className="min-h-screen py-8 px-4">
      <div className="max-w-3xl mx-auto" data-testid="new-problem-container">
        ...
        {activeTab === 'preview' && (
          ...
          >
            <h2 className="text-xl font-semibold mb-2">{formData.title || 'Untitled Problem'}</h2>
            <div
        ...
        {activeTab === 'write' && (
          <form role="form" onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Success Criteria */}
            <div>
              <label htmlFor="successCriteria" className="block font-medium mb-1">
                Success Criteria
              </label>
              <textarea
                id="successCriteria"
            ...
            <div>
              ...
              <p className="text-sm text-muted mt-1">Estimated difficulty level (1-5)</p>
            </div>
